...
export class DataService {
  private  amout = [13,12,4234,45,234,5234,34,534,34,23,23,123,234,123,1234,1238
  ];
  private  names = [
    'Maia dfd df gdf gsdf gsdf gsdf gsdf sdf gsdf gsdf gsdf gsd',
    'Asher',
    'Olivia',
    'Atticus',
    'Amelia',
  ...
  createNewUser(id: number): UserData {
    ...
    return {
      ...
      amout: this.amout[this.getRandomArrayIndex(this.amout.length)]
    };
  }
